 ...
 * 
 * @author David Kolesar 25DEC2019
 */
public class WebFacingConsoleIO {
	...
	public String sanitizeString(String input) {
		...
		if (input.contains("*") || input.contains("select") || input.contains("drop table") || input.contains(";")
				|| input.contains("*") || input.contains("if") || input.contains("+") || input.contains("||")
				|| input.contains("concat") || input.contains("admin") || input.contains("order")
